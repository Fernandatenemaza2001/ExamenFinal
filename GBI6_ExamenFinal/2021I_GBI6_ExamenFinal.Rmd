...
```{r data}
library(readr)
df <- read.csv("C:/Users/UDGS/Documents/GitHub/ExamenFinal/GBI6_ExamenFinal/data/mRNA_expr.csv")
...
En esta tabla se puede observar los principales tipos de cancer y genes, 
La tabla brinda un resumen estadistico de los principales genes y canceres presentes en una dataframe, donde se pueden decir que los 3 proncipales canceres son: BRCA (590), OV (561) y LUSC (154). Ademas, los genes que mas se expresaron respectivamente para estos tipos de cancer son: ESR1 (media 2.3), FN1 (media 1.33) y MUC1 (media 0.56). Al contrario, los canceres con observaciones menores a 100 y 50 fueron KIPAN (88) y UCEC (54), con mayor expresion en el gen PTEM (media 0.72) y ESR1 (media 2.17). Finalmente, el canceer con menor repeticion fue el KIRP con 16 observaciones, con mayor expresion en el gen PTEN.
```
